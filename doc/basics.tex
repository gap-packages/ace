...
default scheme except inverse generators are  included,  each  inverse
generator included immediately are  each  generator  in  the  alphabet
ordering that defines the `lexical' order. By doing this and including
the  columns  for  the  inverse  generators  immediately   after   the
corresponding generators, in  the  coset  table,  one  finds  for  the
