...
`SetInfoLevel(InfoACE, <level>)'). Currently, information from  {\ACE}
is directed to `Info' at two non-zero `InfoACE' levels: 1 and  2.  The
command
...
Interactively,           use            `ACEStandardiseCosetNumbering'
(see~"ACEStandardiseCosetNumbering").
...
(observable when the `InfoLevel' of `InfoACE' is set to at  least  2),
...
check for the inclusion of the statistics package.
...
`ACEStandardiseCosetNumbering' (see~"ACEStandardiseCosetNumbering") is
invoked.

\>ACEStandardiseCosetNumbering( <i> ) F
\>ACEStandardiseCosetNumbering() F
...
Adds the words in the  list  <relatorlist>  to  any  relators  already
present. The enumeration must be restarted or  redone,  it  cannot  be
continued.

\>ACEAddSubgroupGenerators( <i>, <wordlist> ) F
\>ACEAddSubgroupGenerators( <wordlist> ) F

Adds the words in the  list  <wordlist>  to  any  subgroup  generators
already present. The enumeration  must  be  restarted  or  redone,  it
cannot be continued.

\>ACEDeleteRelators( <i>, <relatorlist> ) F
\>ACEDeleteRelators( <relatorlist> ) F

Deletes the words in the list <relatorlist> to  any  relators  already
present. The enumeration must be restarted or  redone,  it  cannot  be
continued.
...
Deletes the words in the list <wordlist> to  any  subgroup  generators
already present. The enumeration  must  be  restarted  or  redone,  it
cannot be continued.
