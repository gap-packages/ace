...
standardisation (see  Section~"Coset  Table  Standardisation  Schemes"
and~"ACEStandardCosetNumbering"   or~"option   standard")    as    the
enumeration proceeds. {\ACE} does not implement table  standardisation
during an enumeration, although incomplete tables can be  standardised
and an enumeration continued. The `sims' option  implements  the  five
odd-numbered non-standardising  strategies  of~\cite{Sim94}  ({\ACE}'s
numbering   of   the    strategies    coincides    with    Section~5.5
