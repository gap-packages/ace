...
##
Revision.ace_compat4r2_gd :=
    "@(#)$Id$";


#############################################################################
##  
#V  ACE_PROVIDE_FUNCTIONS . . . .  list of GAP 4.3 functions ACE must provide
#F  ACE_IF_NEW_DeclareGlobalFunction( <string> ) . . . . declare if necessary
#F  ACE_IF_NEW_DeclareOperation( <string>, <list> )  . . declare if necessary
##
...
##  but also adds  <string>  to  `ACE_PROVIDE_FUNCTIONS'  so  that  when  the
##  companion install file is read the function is installed.
##
##  `ACE_IF_NEW_DeclareOperation' does the same for an operation.
##
ACE_PROVIDE_FUNCTIONS := [];
ACE_IF_NEW_DeclareGlobalFunction := function( string )
  if not IsBoundGlobal( string ) then
    DeclareGlobalFunction( string );
    Add(ACE_PROVIDE_FUNCTIONS, string);
  fi;
end;
ACE_IF_NEW_DeclareOperation := function( string, list )
  if not IsBoundGlobal( string ) then
...
##
ACE_IF_NEW_DeclareGlobalFunction( "Chomp" );
...
##
ACE_IF_NEW_DeclareGlobalFunction( "JoinStringsWithSeparator" );
...
##  options (see~"quit").
##
ACE_IF_NEW_DeclareGlobalFunction( "ResetOptionsStack");
...
##
ACE_IF_NEW_DeclareGlobalFunction( "EvalString" );
...
##
ACE_IF_NEW_DeclareOperation( "IsMatchingSublist", [IsList,IsList,IS_INT] );

#############################################################################
##
#F  StringFile( <name> ) . . . . . . return content of file <name> as string
##
ACE_IF_NEW_DeclareGlobalFunction( "StringFile" );
...
##  them in the {\ACE} package essentially renders  them  as  no-ops,  except
##  that `UNIXSelect' also sleeps 1 second.
##
ACE_IF_NEW_DeclareGlobalFunction( "FileDescriptorOfStream" );
ACE_IF_NEW_DeclareGlobalFunction( "UNIXSelect" );
...
##
ACE_IF_NEW_DeclareOperation( "ReadAllLine", [IsInputStream,IsBool,IsFunction] );
...
##
Unbind( ACE_IF_NEW_DeclareGlobalFunction );
Unbind( ACE_IF_NEW_DeclareOperation );

#E  compat4r2.gd . . . . . . . . . . . . . . . . . . . . . . . . . ends here 
