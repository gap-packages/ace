...
`FlushOptionsStack' (see~"FlushOptionsStack").
...
`CHANGES' in the `gap' directory. However, the only  change  affecting
users who only have knowledge of the release  version  of  the  {\ACE}
Share Package has to do with the change of the  default  standard  for
the numbering of cosets in a coset table from {\GAP} 4.2 to {\GAP} 4.3
