...
introduced in version 3.001 of the {\ACE} Share Package to perform the
same function, is now a synonym  for  `ResetOptionsStack';  it  simply
executes `PopOptions()' until `OptionsStack' is empty.
